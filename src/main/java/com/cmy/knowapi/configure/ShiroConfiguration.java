...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/week/hot", "anon");
        filterChainDefinitionMap.put("/user/answerNum", "anon");
    ...
    @Bean
    public SecurityManager securityManager(MyRealm myShiroRealm) {
    ...
    /**
     * 配合AuthorizationAttributeSourceAdvisor开启shiro aop注解支持 使用，否则注解无效
     *
     * @return
     */
    @Bean
